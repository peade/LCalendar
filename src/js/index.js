    ...
    MobileCalendar.prototype = {
        ...
        bindEvent: function (type) {
            ...
            function dateCtrlInit () {
                ...
                } else if (/^\d{4}-\d{1,2}-\d{1,2}$/.test(_self.defaultDate)) {
                    rs = _self.defaultDate.match(/(^|-)\d{1,4}/g);
                    dateArr.yy = rs[0] - _self.minY;
                    dateArr.mm = rs[1].replace(/-/g, "") - 1;
                    dateArr.dd = rs[2].replace(/-/g, "") - 1;
                } else {
            ...
            function ymCtrlInit () {
                ...
                if (/^\d{4}-\d{1,2}$/.test(_self.trigger.value)) {
                    ...
                    dateArr.yy = rs[0] - _self.minY;
                    dateArr.mm = rs[1].replace(/-/g, "") - 1;
                } else if (/^\d{4}-\d{1,2}$/.test(_self.defaultDate)) {
                    rs = _self.defaultDate.match(/(^|-)\d{1,4}/g);
                    dateArr.yy = rs[0] - _self.minY;
                    dateArr.mm = rs[1].replace(/-/g, "") - 1;
                } else {
            ...
            function dateTimeCtrlInit () {
                ...
                } else if (/^\d{4}-\d{1,2}-\d{1,2}\s\d{2}:\d{2}$/.test(_self.defaultDate)) {
                    rs = _self.defaultDate.match(/(^|-|\s|:)\d{1,4}/g);
                    dateArr.yy = rs[0] - _self.minY;
                    dateArr.mm = rs[1].replace(/-/g, "") - 1;
                    dateArr.dd = rs[2].replace(/-/g, "") - 1;
                    dateArr.hh = parseInt(rs[3].replace(/\s0?/g, ""));
